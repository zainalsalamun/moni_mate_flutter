...
class AiInsightApiService {
  ...
  static Future<List<PredictiveInsightModel>> generateCoachInsights(FinancialContextModel context) async {
...
''';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final textResponse = data['choices']?[0]?['message']?['content']?.trim() ?? '';
