...
android {
    namespace = "com.naltech.moni_mate_flutter"
    ...
    defaultConfig {
        ...
        applicationId = "com.naltech.moni_mate_flutter"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        minSdk = flutter.minSdkVersion // Required for some plugins or better to set explicitly
